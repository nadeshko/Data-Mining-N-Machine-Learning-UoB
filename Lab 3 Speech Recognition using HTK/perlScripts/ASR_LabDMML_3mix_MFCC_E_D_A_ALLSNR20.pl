...
$LIST_test	= "$REC_DIR/list/listTestFullPath_LabDMML_N1_SNR20.scp"; 
$LIST_test_HCopy= "$REC_DIR/list/listTestHCopy_LabDMML_N1_SNR20.scp";
...
$RESULT 	= "$REC_DIR\\result\\RecognitionAllTraining_Result_SNR20.res";
